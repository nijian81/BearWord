 ...
 */
public class MyNoteFragment extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener {
    ...
    public List<AVObject> findAVObjects() {
        // 查询当前AVObject列表
        AVQuery<AVObject> query = new AVQuery<>("WordTipsNote");
        // 按照更新时间降序排序
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.close:
                    ...
                    break;
                case R.id.delete:
                    AVQuery avQuery = new AVQuery("WordTipsNote");
                ...
                case R.id.save:
                    if (note.getText().toString().length() == 0) {
                        ...
                        AVQuery<AVObject> avQuery1 = new AVQuery("WordTipsNote");
