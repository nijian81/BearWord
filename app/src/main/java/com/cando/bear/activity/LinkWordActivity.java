...
public class LinkWordActivity extends AppCompatActivity implements View.OnClickListener, MaterialTabListener {
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.link_word);
        ...
        LinkWordActivity.this.progressDialog =
                                        ...
                                        if (i == 104) {
                                            ...
                                            avUser.saveInBackground(new SaveCallback() {
                                                ...
                                                public void done(AVException e) {
                                                    Toast toast = Toast.makeText(LinkWordActivity.this, "本轮学习之后，您会将所有单词背诵完一遍哦~", Toast.LENGTH_LONG);
                                                    toast.show();
                                                }
                                            });
                                            break;
    ...
    AlertDialog getAlertDialogWithTaskComplete() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                intent = new Intent(LinkWordActivity.this, MainActivity.class);
                startActivity(intent);
                //新的activity进入动画，旧的activity退出的动画
                overridePendingTransition(R.anim.enter_from_left, R.anim.exit_to_right);
            }
...
//        materialTab  =tab;
        ...
        pagerSynAndAnt.setCurrentItem(tab.getPosition());
        pagerOrigin.setCurrentItem(tab.getPosition());
        pagerMeaning.setCurrentItem(tab.getPosition());
    }
